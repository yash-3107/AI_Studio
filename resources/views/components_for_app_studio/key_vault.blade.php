    ...
    <div class="content-area">
        ...
        @else
            ...
            <div class="empty-state">
                ...
                <!-- Modal -->
                <div class="modal fade" id="createKeyModal" tabindex="-1" aria-labelledby="createKeyModalLabel"
                    aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="createKeyForm">
                                    <!-- Type Selection -->
                                    <div class="mb-4">
                                        <label class="form-label" style="justify-content: start;">Type</label>
                                        <div class="btn-group w-100" role="group" aria-label="Key type selection">
                                            <input type="radio" class="btn-check" name="keyType" id="generic"
                                                value="generic" checked>
                                            <label class="btn btn-outline-secondary" for="generic">Generic</label>

                                            <input type="radio" class="btn-check" name="keyType" id="credential"
                                                value="credential">
                                            <label class="btn btn-outline-secondary" for="credential">Credential</label>
                                        </div>
                                    </div>

                                    <!-- Key Input -->
                                    <div class="mb-4">
                                        <label for="keyInput" class="form-label" style="justify-content: start;">
                                            Key <span class="required">*</span>
                                        </label>
                                        <input type="text" class="form-control" id="keyInput" placeholder="Enter key"
                                            maxlength="50" required>
                                        <div class="char-count" id="keyCharCount">0/50</div>
                                    </div>

                                    <!-- Value Input -->
                                    <div class="mb-4">
                                        <label for="valueInput" class="form-label" style="justify-content: start;">
                                            Value <span class="required">*</span>
                                        </label>
                                        <textarea class="form-control" id="valueInput" placeholder="Enter value"
                                            required></textarea>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="empty-content">
                    ...
                    <button class="create-key-btn" data-bs-toggle="modal" data-bs-target="#createKeyModal">
