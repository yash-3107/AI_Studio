...
(function () {
    ...
    option = {
        ...
        color: ["rgb(84, 109, 254)", "rgb(175 ,109, 237)", "rgb(244, 167, 66)", "rgb(12, 163, 231)", "rgb(221 ,58, 82)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(84, 109, 254)", "rgb(175 ,109, 237)", "rgb(244, 167, 66)", "rgb(221 ,58, 82)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(84, 109, 254)", "rgb(175 ,109, 237)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(84, 109, 254)", "rgb(175 ,109, 237)", "rgb(244, 167, 66)", "rgb(221 ,58, 82)", "rgb(12, 163, 231)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(12, 163, 231)", "rgb(221 ,58, 82)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
        ...
        series: [
            {
                ...
                itemStyle: {
                    normal: {
                        color: "rgb(84, 109, 254)",
                        color0: "rgb(175 ,109, 237)",
                        borderColor: "rgb(84, 109, 254)",
                        borderColor0: "rgb(175 ,109, 237)",
                    }
                }
            }
        ]
